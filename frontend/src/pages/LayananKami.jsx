      ...
      <div className="w-full max-w-[1200px] px-10 flex flex-col gap-6">
        <div data-aos="fade-down">
          ...
          <h1 className="text-white text-3xl lg:text-4xl font-bold leading-snug mt-3">
            Perlindungan Digital untuk <br className="hidden md:block" />
        ...
        >
          ...
          <div
            data-aos="flip-left"
            data-aos-delay="150"
            className="bg-white rounded-xl p-8 flex flex-col gap-4 hover:shadow-2xl transition duration-300"
          >
            <img
              src={deteksilayanan}
              alt="icon"
          ...
          <div
            ...
            className="bg-white rounded-xl p-8 flex flex-col gap-4 hover:shadow-2xl transition duration-300"
          >
            <img src={deteksiqr} alt="icon" className="w-[100px] h-[100px]" />
            <h2 className="text-[#05B14F] font-bold text-2xl">
